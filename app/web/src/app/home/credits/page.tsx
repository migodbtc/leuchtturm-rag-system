  ...
  return (
    ...
    >
      ...
      <motion.section
        ...
        initial="hidden"
        animate="visible"
        className="w-full grid gap-4 sm:grid-cols-1 md:grid-cols-2"
      >
        <motion.div
          variants={itemVariants}
          className="rounded-lg border border-slate-300 bg-white p-5 flex flex-col gap-2"
        >
          <motion.h2
            variants={itemVariants}
            className="text-lg font-semibold text-black flex flex-row gap-2 items-center"
          >
            <BrainCircuit className="text-amber-300" /> Leuchtturm RAG System
          </motion.h2>
          <motion.p
            variants={itemVariants}
            className="text-sm text-gray-700 text-justify wrap-break-word"
          >
          ...
          <motion.table
            variants={itemVariants}
            className="mt-2 w-full text-sm text-gray-700 border-separate border-spacing-y-2"
          >
            <tbody>
              <tr>
        ...
        >
          ...
          <motion.p
            variants={itemVariants}
            className="mt-2 text-sm text-gray-700 text-justify wrap-break-word"
          >
          ...
          <motion.table
            variants={itemVariants}
            className="mt-2 w-full table-fixed text-sm text-gray-700 border-separate border-spacing-y-2"
          >
            <tbody>
              <tr>
                <td className="p-0 w-1/2 font-bold text-black">
              ...
              <tr>
                ...
                <td className="p-0 text-right">Backend Dev · Flex Dev</td>
              </tr>
              <tr>
                <td className="p-0 w-1/2 font-bold text-black">
                  Joeren Formento
